  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="./index.html">
        <img src="{{asset('')}}dashboard_assets/img/brand/blue.png" class="navbar-brand-img" alt="...">
      </a>
      <!-- User -->
          ...
          <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="media align-items-center">
              <span class="avatar avatar-sm rounded-circle">
                <img alt="Image placeholder" src="{{asset('')}}dashboard_assets/img/theme/team-1-800x800.jpg
">
              </span>
            </div>
          </a>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link " href="./examples/maps.html">
              <i class="ni ni-pin-3 text-orange"></i> My group
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="./examples/maps.html">
...
@yield('content')
  ...
  <!--   Optional JS   -->
  <script src="{{asset('')}}dashboard_assets/js/plugins/chart.js/dist/Chart.min.js"></script>
  <script src="{{asset('')}}dashboard_assets/js/plugins/chart.js/dist/Chart.extension.js"></script>
  <!--   Argon JS   -->
